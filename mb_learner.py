...
if __name__ =='__main__':
    ...
    replay_buffer = Buffer(max_len=200000)
    MB_env = SubprocVecEnv([ lambda: AsynMB(env_data=env_data, replay_buffer=replay_buffer, name='0', n_steps=256),
                             lambda: AsynMB(env_data=env_data, replay_buffer=replay_buffer, name='1', n_steps=256),
